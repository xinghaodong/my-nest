...
INSERT INTO `internal_user` VALUES (45,'xhd','邢浩东','2024-12-19 07:31:42.000000','2024-12-26 03:28:36.000000',77,'975115611@qq.com','','$2a$10$cAX3.JibP6YoAOB./0EZuO/vBxWZg.k4Eu65cC2Mw8IkMRggLx.di'),(48,'邢景潇','xjx','2024-12-25 05:46:06.475143','2024-12-25 06:20:34.000000',78,'975115612@qq.com','','$2a$10$xeDkLXQ9PPFDGAHE1CHPreXxYSHJuOo3kwAptowJH8t/e4H/.hVRy'),(49,'huyue','胡悦','2024-12-26 02:50:05.760128','2024-12-26 02:50:05.760128',81,'',NULL,'$2a$10$0u3ux6fQIEDU0wb2wA4/9ulMvuHngqBwSWXz8sR23pVMJs9Im5kXW'),(50,'xingwu','邢武','2024-12-26 03:09:41.000000','2024-12-26 06:24:49.000000',82,'975115616@qq.com','','$2a$10$MMe30qOqan1wZ6Y3kOPYguTv02GckAD1PMe5Jc67n.XYx0tzvf4k.');
...
INSERT INTO `internal_user_roles_role` VALUES (45,1),(49,1),(49,2),(50,1);
...
INSERT INTO `menu` VALUES (21,'系统设置','',NULL,'','Setting','','',2,'xtsz'),(25,'角色管理','roleManagement',21,'systemSetting/roleManagement','Grid','1','',1,'roleManagement'),(26,'员工管理','internalusers',21,'systemSetting/internalusers','User','0','',0,'internalusers'),(33,'组织架构','management',21,'systemSetting/management','Avatar','1','',3,'management');
/*!40000 ALTER TABLE `menu` ENABLE KEYS */;

--
-- Table structure for table `menu_roles_role`
--

DROP TABLE IF EXISTS `menu_roles_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `menu_roles_role` (
  `menuId` int NOT NULL,
  `roleId` int NOT NULL,
  PRIMARY KEY (`menuId`,`roleId`),
  KEY `IDX_fe52b8dbda7b8d948170304c1f` (`menuId`),
  KEY `IDX_f55b26bde1f8e4381035226873` (`roleId`),
  CONSTRAINT `FK_f55b26bde1f8e43810352268739` FOREIGN KEY (`roleId`) REFERENCES `role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_fe52b8dbda7b8d948170304c1f2` FOREIGN KEY (`menuId`) REFERENCES `menu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `menu_roles_role`
--

/*!40000 ALTER TABLE `menu_roles_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `menu_roles_role` ENABLE KEYS */;
...
INSERT INTO `org_management` VALUES (1,NULL,'top1','1');
...
INSERT INTO `role_menus_menu` VALUES (1,25),(10,21),(10,26);
...
-- Dump completed on 2024-12-27 18:17:28
